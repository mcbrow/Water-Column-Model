 ...
 */
void initmod(void(* odeparms)(int *, double *, double *, double *, double *, 
                  double *, double *, double *, double *, double *))
{
  int N=374;
 
  odeparms(&N, &parms.z[0], &parms.k[0], &parms.s[0], 
...
in C than in R. Structures are faster and less laborious than macros */  
  struct var{
    double kd[74];
    double sd[74];
    double md[74];
  ...
  dyn.kd[i]=parms.k[i-1]/(parms.z[i-1]+parms.z[i]);
